...
var transporter =nodemailer.createTransport({
    service:'gmail',
    auth:{
    user:'zebaaachraf39@gmail.com',
    pass:'kbycxxuvheazgeph'
    },
    tls:{
...
await newUser.save();
const mailOption = {
    from: '"verify your email " <zebaaachraf39@gmail.com@gmail.com>',
    to: newUser.email,
...
const generateToken = (user) => {
    return jwt.sign({ user }, process.env.TOKEN, { expiresIn: '600s' });
    };
    // Login
